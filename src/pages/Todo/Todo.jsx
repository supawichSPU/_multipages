...
function Todo() {
    ...
    function waitingClick(id) {
        const todoSeleted = todosRaw.find((todo) => todo.id === id)
        todoSeleted.completed = true
        ...
        <div className='todo-container'>
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title><span className='bi bi-plus-circle'>&nbsp;Add Todo</span></Modal.Title>
                </Modal.Header>
            ...
            <table className='table table-striped todo-table'>
                <thead className='table-dark'>
                    <tr>
                        <th style={{ width: '7%' }} valign='middle'>ID</th>
